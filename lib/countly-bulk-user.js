...
function CountlyBulkUser(conf) {
    ...
    **/
    this.add_event = function(event) {
        event.key = truncateSingleValue(event.key, conf.maxKeyLength, "add_event", conf.debug);
        event.segmentation = truncateObject(event.segmentation, conf.maxKeyLength, conf.maxValueSize, conf.maxSegmentationValues, "add_event", conf.debug);
    ...
    **/
    this.user_details = function(user) {
        if (this.check_consent("users")) {
            user.name = truncateSingleValue(user.name, conf.maxValueSize, "user_details", conf.debug);
            user.username = truncateSingleValue(user.username, conf.maxValueSize, "user_details", conf.debug);
            user.email = truncateSingleValue(user.email, conf.maxValueSize, "user_details", conf.debug);
            user.organization = truncateSingleValue(user.organization, conf.maxValueSize, "user_details", conf.debug);
            user.phone = truncateSingleValue(user.phone, conf.maxValueSize, "user_details", conf.debug);
            user.picture = truncateSingleValue(user.picture, 4096, "user_details", conf.debug);
            user.gender = truncateSingleValue(user.gender, conf.maxValueSize, "user_details", conf.debug);
            user.byear = truncateSingleValue(user.byear, conf.maxValueSize, "user_details", conf.debug);
            user.custom = truncateObject(user.custom, conf.maxKeyLength, conf.maxValueSize, conf.maxSegmentationValues, "user_details", conf.debug);
    ...
    **/
    this.report_conversion = function(campaign_id, campaign_user_id, timestamp) {
        if (this.check_consent("attribution")) {
            ...
            if (campaign_id) {
                campaign_id = truncateSingleValue(campaign_id, conf.maxValueSize, "report_conversion", conf.debug);

                query.campaign_id = campaign_id;
            }

            if (campaign_user_id) {
                campaign_user_id = truncateSingleValue(campaign_user_id, conf.maxValueSize, "report_conversion", conf.debug);
    ...
    **/
    this.report_view = function(view_name, timestamp, duration, viewSegments) {
        view_name = truncateSingleValue(view_name, conf.maxValueSize, "report_view", conf.debug);
    ...
    **/
    ...
    this.report_trace = function(trace) {
        if (this.check_consent("apm")) {
            trace.name = truncateSingleValue(trace.name, conf.maxKeyLength, "report_trace", conf.debug);
            trace.app_metrics = truncateObject(trace.app_metrics, conf.maxKeyLength, conf.maxValueSize, conf.maxSegmentationValues, "report_trace", conf.debug);
    ...
    **/
    ...
    var change_custom_property = function(key, value, mod) {
        key = truncateSingleValue(key, conf.maxKeyLength, "change_custom_property", conf.debug);
        value = truncateSingleValue(value, conf.maxValueSize, "change_custom_property", conf.debug);
    ...
    **/
    this.custom_set = function(key, value) {
        key = truncateSingleValue(key, conf.maxKeyLength, "custom_set", conf.debug);
        value = truncateSingleValue(value, conf.maxValueSize, "custom_set", conf.debug);
    ...
    **/
    this.custom_set_once = function(key, value) {
        key = truncateSingleValue(key, conf.maxKeyLength, "custom_set_once", conf.debug);
        value = truncateSingleValue(value, conf.maxValueSize, "custom_set_once", conf.debug);
    ...
    **/
    this.custom_unset = function(key) {
        key = truncateSingleValue(key, conf.maxKeyLength, "custom_unset", conf.debug);
        customData[key] = "";
        return this;
    };
    /**
    ...
    **/
    this.custom_increment = function(key) {
        key = truncateSingleValue(key, conf.maxKeyLength, "custom_increment", conf.debug);
    ...
    **/
    this.custom_increment_by = function(key, value) {
        key = truncateSingleValue(key, conf.maxKeyLength, "custom_increment_by", conf.debug);
        value = truncateSingleValue(value, conf.maxValueSize, "custom_increment_by", conf.debug);
    ...
    **/
    this.custom_multiply = function(key, value) {
        key = truncateSingleValue(key, conf.maxKeyLength, "custom_multiply", conf.debug);
        value = truncateSingleValue(value, conf.maxValueSize, "custom_multiply", conf.debug);
    ...
    **/
    this.custom_max = function(key, value) {
        key = truncateSingleValue(key, conf.maxKeyLength, "custom_max", conf.debug);
        value = truncateSingleValue(value, conf.maxValueSize, "custom_max", conf.debug);
    ...
    **/
    this.custom_min = function(key, value) {
        key = truncateSingleValue(key, conf.maxKeyLength, "custom_min", conf.debug);
        value = truncateSingleValue(value, conf.maxValueSize, "custom_min", conf.debug);
    ...
    **/
    this.custom_push = function(key, value) {
        key = truncateSingleValue(key, conf.maxKeyLength, "custom_push", conf.debug);
        value = truncateSingleValue(value, conf.maxValueSize, "custom_push", conf.debug);
    ...
    **/
    this.custom_push_unique = function(key, value) {
        key = truncateSingleValue(key, conf.maxKeyLength, "custom_push_unique", conf.debug);
        value = truncateSingleValue(value, conf.maxValueSize, "custom_push_unique", conf.debug);
    ...
    **/
    this.custom_pull = function(key, value) {
        key = truncateSingleValue(key, conf.maxKeyLength, "custom_pull", conf.debug);
        value = truncateSingleValue(value, conf.maxValueSize, "custom_pull", conf.debug);
