    ...
    */
    this.check_consent = function(feature) {
        if (!conf.require_consent) {
            ...
            cc.log("Require consent is off. Giving consent for : [ " + feature + " ] feature.");
            return true;
        }
        if (consents[feature] && consents[feature].optin) {
            cc.log("Giving consent for : [ " + feature + " ] feature.");
            return true;
        }
        if (consents[feature] && !consents[feature].optin) {
            cc.log("User is not optin. Consent refused for : [ " + feature + " ] feature.");
            return false;
        }
        else {
            cc.log("No feature available for : [ " + feature + " ] feature.");
        }
        return false;
    };
