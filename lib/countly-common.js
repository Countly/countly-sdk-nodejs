    ...
    */
    ...
    isResponseValid: function isResponseValid(statusCode, str) {
        ...
        if (!(statusCode >= 200 && statusCode < 300)) {
            this.log(this.logLevelEnums.ERROR, `isResponseValid, The server status code: [${statusCode}]`);
            return false;
        }
        ...
        try {
            ...
            if (response.result) {
                // if the result field exist we return true
                return true;
            }
            // result field was not there
            this.log(this.logLevelEnums.INFO, `isResponseValid, The server response has no response field`);
            return false;
        }
        catch (e) {
