 ...
 */
     ...
     * 
     * Resets Countly to its initial state (used mainly to wipe the queues in memory) and must be coupled with Countly.init to change configuration:
     * //initial initialization
     * Countly.init({....});
     * ...
     * //wipe the state but not config
     * Countly.halt();
     * //New init with new config
     * Countly.init({....});
     */
