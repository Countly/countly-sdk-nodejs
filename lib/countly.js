...
var {truncateObject, truncateSingleValue} = require("../lib/countly-common.js");
 ...
 */
    ...
    **/
    Countly.change_id = function(newId, merge) {
        newId = truncateSingleValue(newId, Countly.maxValueSize, "change_id", Countly.debug);
        if (cluster.isMaster) {
    ...
    */
    function add_cly_events(event) {
        ...
        if (cluster.isMaster) {
            ...
            event.key = truncateSingleValue(event.key, Countly.maxKeyLength, "add_cly_event", Countly.debug);
            event.segmentation = truncateObject(event.segmentation, Countly.maxKeyLength, Countly.maxValueSize, Countly.maxSegmentationValues, "add_cly_event", Countly.debug);
    ...
    **/
    Countly.start_event = function(key) {
        key = truncateSingleValue(key, Countly.maxKeyLength, "start_event", Countly.debug);
        if (timedEvents[key]) {
    ...
    **/
    Countly.end_event = function(event) {
        if (typeof event === "string") {
            event = truncateSingleValue(event, Countly.maxKeyLength, "end_event", Countly.debug);
            event = {key: event};
        }
        if (!event.key) {
            log("Event must have key property");
        ...
        event.key = truncateSingleValue(event.key, Countly.maxKeyLength, "end_event", Countly.debug);
    ...
    **/
    Countly.user_details = function(user) {
        log("Trying to add userdetails: ", user);
        if (Countly.check_consent("users")) {
            var props = ["name", "username", "email", "organization", "phone", "picture", "gender", "byear", "custom"];
            user.name = truncateSingleValue(user.name, Countly.maxValueSize, "user_details", Countly.debug);
            user.username = truncateSingleValue(user.username, Countly.maxValueSize, "user_details", Countly.debug);
            user.email = truncateSingleValue(user.email, Countly.maxValueSize, "user_details", Countly.debug);
            user.organization = truncateSingleValue(user.organization, Countly.maxValueSize, "user_details", Countly.debug);
            user.phone = truncateSingleValue(user.phone, Countly.maxValueSize, "user_details", Countly.debug);
            user.picture = truncateSingleValue(user.picture, 4096, "user_details", Countly.debug);
            user.gender = truncateSingleValue(user.gender, Countly.maxValueSize, "user_details", Countly.debug);
            user.byear = truncateSingleValue(user.byear, Countly.maxValueSize, "user_details", Countly.debug);
            user.custom = truncateObject(user.custom, Countly.maxKeyLength, Countly.maxValueSize, Countly.maxSegmentationValues, "user_details", Countly.debug);
    ...
    **************************/
    ...
    var change_custom_property = function(key, value, mod) {
        key = truncateSingleValue(key, Countly.maxKeyLength, "change_custom_property", Countly.debug);
        value = truncateSingleValue(value, Countly.maxValueSize, "change_custom_property", Countly.debug);
    ...
    Countly.userData = {
        ...
        **/
        set: function(key, value) {
            key = truncateSingleValue(key, Countly.maxKeyLength, "set", Countly.debug);
            value = truncateSingleValue(value, Countly.maxValueSize, "set", Countly.debug);
        ...
        **/
        set_once: function(key, value) {
            key = truncateSingleValue(key, Countly.maxKeyLength, "set_once", Countly.debug);
            value = truncateSingleValue(value, Countly.maxValueSize, "set_once", Countly.debug);
        ...
        **/
        unset: function(key) {
            key = truncateSingleValue(key, Countly.maxKeyLength, "unset", Countly.debug);
            customData[key] = "";
        },
        /**
        ...
        **/
        increment: function(key) {
            key = truncateSingleValue(key, Countly.maxKeyLength, "increment", Countly.debug);
        ...
        **/
        increment_by: function(key, value) {
            key = truncateSingleValue(key, Countly.maxKeyLength, "increment_by", Countly.debug);
            value = truncateSingleValue(value, Countly.maxValueSize, "increment_by", Countly.debug);
        ...
        **/
        multiply: function(key, value) {
            key = truncateSingleValue(key, Countly.maxKeyLength, "multiply", Countly.debug);
            value = truncateSingleValue(value, Countly.maxValueSize, "multiply", Countly.debug);
        ...
        **/
        max: function(key, value) {
            key = truncateSingleValue(key, Countly.maxKeyLength, "max", Countly.debug);
            value = truncateSingleValue(value, Countly.maxValueSize, "max", Countly.debug);
        ...
        **/
        min: function(key, value) {
            key = truncateSingleValue(key, Countly.maxKeyLength, "min", Countly.debug);
            value = truncateSingleValue(value, Countly.maxValueSize, "min", Countly.debug);
        ...
        **/
        push: function(key, value) {
            key = truncateSingleValue(key, Countly.maxKeyLength, "push", Countly.debug);
            value = truncateSingleValue(value, Countly.maxValueSize, "push", Countly.debug);
        ...
        **/
        push_unique: function(key, value) {
            key = truncateSingleValue(key, Countly.maxKeyLength, "push_unique", Countly.debug);
            value = truncateSingleValue(value, Countly.maxValueSize, "push_unique", Countly.debug);
        ...
        **/
        pull: function(key, value) {
            key = truncateSingleValue(key, Countly.maxKeyLength, "pull", Countly.debug);
            value = truncateSingleValue(value, Countly.maxValueSize, "pull", Countly.debug);
    ...
    Countly.report_conversion = function(campaign_id, campaign_user_id) {
        if (Countly.check_consent("attribution")) {
            if (campaign_id && campaign_user_id) {
                campaign_id = truncateSingleValue(campaign_id, Countly.maxValueSize, "report_conversion", Countly.debug);
                campaign_user_id = truncateSingleValue(campaign_user_id, Countly.maxValueSize, "report_conversion", Countly.debug);
    ...
    **/
    Countly.add_log = function(record) {
        if (Countly.check_consent("crashes")) {
            record = truncateSingleValue(record, Countly.maxValueSize, "add_log", Countly.debug);
            if (crashLogs.length > maxBreadcrumbCount) {
                crashLogs.shift();
            }
    ...
    **/
    Countly.track_view = function(name, viewSegments) {
        reportViewDuration();
        if (name) {
            name = truncateSingleValue(name, Countly.maxValueSize, "track_view", Countly.debug);
            lastView = name;
            ...
            if (viewSegments) {
                viewSegments = truncateObject(viewSegments, Countly.maxKeyLength, Countly.maxValueSize, Countly.maxSegmentationValues, "track_view", Countly.debug);
    ...
    **/
    ...
    Countly.report_trace = function(trace) {
        if (Countly.check_consent("apm")) {
            trace.name = truncateSingleValue(trace.name, Countly.maxKeyLength, "report_trace", Countly.debug);
            trace.app_metrics = truncateObject(trace.app_metrics, Countly.maxKeyLength, Countly.maxValueSize, Countly.maxSegmentationValues, "report_trace", Countly.debug);
    ...
    **/
    Countly.request = function(request) {
        request = truncateObject(request, Countly.maxKeyLength, Countly.maxValueSize, Countly.maxSegmentationValues, "request", Countly.debug);
    ...
    */
    function recordError(err, nonfatal, segments) {
        if (Countly.check_consent("crashes") && err) {
            ...
            segments = truncateObject(segments, Countly.maxKeyLength, Countly.maxValueSize, Countly.maxSegmentationValues, "record_error", Countly.debug);
