 ...
 */
     ...
     * @param {boolean} preventRequestProcess - if true request queues wont be processed, for testing purposes
     */
    Countly.halt = function(preventRequestProcess) {
        ...
        sessionUpdate = 60;
        maxEventBatch = 100;
        readyToProcess = !preventRequestProcess;
        trackTime = true;
        metrics = {};
        lastParams = {};
        maxKeyLength = 128;
