    ...
    **/
    Countly.add_event = function(event) {
        ...
        case internalEventKeyEnums.NPS:
            ...
            log('This event: [' + event.key + '] got feedback consent');
            break;
